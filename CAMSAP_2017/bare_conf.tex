...
a solution that jointly estimates the spatio characteristics and
...
uniqueness to assign the minimum number of beams and pilot sequence length. The
simulation results show that the proposed solution can achieve very accurate
estimates if the system meets Kruskal conditions. 
\end{abstract}
